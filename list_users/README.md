# Zoom Active Users Export Script
...
These values come from your **Zoom App Credentials** in the Zoom Developer Portal [^1].
...
** 3. Export to CSV**
The retrieved user data is written to a CSV file using the `list_to_csv()` helper function 1.
